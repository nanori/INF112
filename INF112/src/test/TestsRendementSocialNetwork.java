...
public class TestsRendementSocialNetwork {
	...
	private static float addMembers(SocialNetwork sn, int nbMembers){
		...
		try{
			...
			System.out.println("Test rendement addMembers : exception non prévue. " + e);
			e.printStackTrace();
		}
	...
	private static float addItems(SocialNetwork sn, int nbMembres){
		...
		try{
			...
			System.out.println("Test rendement addItems : exception non prévue. " + e);
			e.printStackTrace();
		}
	...
	private static float addAvis(SocialNetwork sn, int nbMembres){
		...
		try{
			...
			System.out.println("Test rendement addAvis : exception non prévue. " + e);
			e.printStackTrace();
		}
