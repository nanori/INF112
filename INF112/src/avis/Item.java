...
public abstract class Item {
	...
	/**
	 * Constructeur Item <br>
	 * A la construction d'un item, la liste avis est instanciée avec une liste
	 * vide.
	 * 
	 * @param titre
	...
	/**
	 * Test si le titre en parametre correspond au titre de l'item. <br>
	 ...
	 * 
	 * @return Moyenne des notes pondérées de l'item
	 */
